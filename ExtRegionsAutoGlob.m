function  [DataImagenes,Cent]=ExtRegionsAutoGlob(I,cimg,ImTemplate,cimgT,ficheroCamino,Trelaj)


%se prepara la mascara
[Mask,Cent] = prepmask(ImTemplate,cimgT,Trelaj);
numImag=length(I);
%%
...
for t=1:numImag
    DataImagenes{t}=ImageDataAutoGlob(I{t},Mask,cimg{t},Trelaj);
end
