function  DataImagenes=ExtRegions(I,cimg,centers,vradii,ficheroCamino,Trelaj)
...
for t=1:numImag
    Mask=circlemask(size(I{t}),centers,vradii);
    %si es inversion recovery rescalar los valores
    DataImagenes{t}=ImageData(I{t},Mask,cimg{t},Trelaj);
end
